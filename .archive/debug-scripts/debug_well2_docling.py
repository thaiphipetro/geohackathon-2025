"""Debug: See Docling's markdown output for Well 2"""
import sys
...
if eowr_files:
    ...
    # Save to file
    output_file = Path(__file__).parent.parent / "outputs" / "exploration" / "well_2_docling_markdown.txt"
    output_file.parent.mkdir(parents=True, exist_ok=True)

    with open(output_file, 'w', encoding='utf-8') as f:
        f.write(markdown)

    print(f"Saved Docling markdown to: {output_file}")
